...
MODEL_DIR = Path.joinpath(settings.BASE_DIR, "ml/htr/model/")
...
class Model:
    ...
    def setup_ctc(self) -> None:
        ...
        # word beam search decoding (see https://github.com/githubharald/CTCWordBeamSearch)
            ...
            word_chars = open(Path.joinpath(MODEL_DIR,'wordCharList.txt')).read().splitlines()[0]
            corpus = open(Path.joinpath(MODEL_DIR, 'corpus.txt')).read()
